...
def get_cpu_utilization():
    ...
    for result in results:
        print (result.metric.labels["instance_name"], "{}%".format(round(result.points[-1].value.double_value*100, 2)))
...
def get_memory_utilization():
    ...
    for result in results:
        # print(result)
        print (result.resource.labels["instance_id"], "{}%".format(round(result.points[-1].value.double_value, 3)))
        # print(result.points[-1].interval.start_time, result.points[0].interval.end_time)
        # for point in result.points:
...
def get_container_cpu_utilization_staging():
    ...
    for result in results:
        print(result.resource.labels["namespace_name"], result.resource.labels["container_name"], "{}%".format(round(result.points[-1].value.double_value*100, 2)))
        # print(result)
        # print(result.points[-1].interval.start_time, result.points[0].interval.end_time)
        # for point in result.points:
        #     print(point.value.double_value * 100)
